# Combine training output for model and feature selection
# author James Barrett
# last edit Charlotte - 16-03-2021
# for combine_sets type=Slope, also intercept will be given (ideal calibration intercept=0, slope=1)
